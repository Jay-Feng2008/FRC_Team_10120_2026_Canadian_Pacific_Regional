...
public class CFCSMirroredClimb {
  public static Command build(
    ...
    return Commands.sequence(
        Commands.parallel(
            Commands.sequence(
                    ...
                    () ->
                        drive.setPose(
                            AllianceFlipUtil.apply(
                                new Pose2d(3.550, 5.864, Rotation2d.fromDegrees(-90))))),
                ...
                Commands.parallel(
                    ...
                    .withTimeout(0.5),
                AutoUtil.followPath("TraverseHerdMirrored4Climb"),
                new SmashBumpCommand(drive)),
        ...
        Commands.parallel(
            ...
            .withTimeout(3),
        AutoUtil.followPath("PostSmashApprochTower_R"),
        Commands.either(
